...
type LookupParams struct {
	...
	DeletedEntries chan<- *ServiceEntry // Channel for Deleted Entries

	Events chan<- *ServiceEvent // Channel for Events - Both updated/deleted
...
func (l *LookupParams) done() {
	...
	if l.DeletedEntries != nil {
		close(l.DeletedEntries)
	}
